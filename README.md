# Sensirion I²C SEN63C Arduino Library

This is the Sensirion SEN63C library for Arduino allowing you to
communicate with a SEN63C sensor over I²C.
...
Search for the `Sensirion I2C SEN63C` library in the `Filter
...
Use the following pin description to connect your SEN63C to the standard I²C bus of your Arduino board:
...
| *SEN63C* | *SEN63C Pin* | *Cable Color* | *Board Pin* |
| :---: | --- | --- | --- |
| VDD | 1 | red | 3.3V |
| GND | 2 | black | GND |
| SDA | 3 | green | D18/SDA |
...
2. Connect the SEN63C sensor to your Arduino as explained in [Connect the sensor](#connect-the-sensor)

3. Open the `exampleUsage` sample project within the Arduino IDE:

   `File` ➔ `Examples` ➔ `Sensirion I2C SEN63C` ➔ `exampleUsage`
